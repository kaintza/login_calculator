class LoginCalculator
  ...
  def calculate
    ...
    logins.transform_keys{ |key| key = @people.select {|p| p[0] == key}.first[1] }
  end
end
   ...
   #"                                                 "angelo"=>{1982=>1, 2006=>1, 1988=>1, 1992=>2, 2016=>1, 1995=>2},
     #                                               "luca"=>{1992=>1, 1970=>1, 1972=>1, 1978=>1, 1976=>1, 2004=>1, 2009=>1, 2011=>1}},
        ...
        logins = { # ugly on purpose
                   0 => [rand_time, rand_time, rand_time, rand_time, rand_time, rand_time, rand_time, rand_time], 1 => [rand_time, rand_time, rand_time, rand_time, rand_time, rand_time, rand_time, rand_time],
...
login_cal = LoginCalculator.new(people, logins)
puts login_cal.calculate